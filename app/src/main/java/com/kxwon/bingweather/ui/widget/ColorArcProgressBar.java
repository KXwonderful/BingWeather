package com.kxwon.bingweather.ui.widget;
...
public class ColorArcProgressBar extends View{
    ...
    private void initView() {
        ...
        allArcPaint.setColor(Color.GRAY);
        ...
        vTextPaint.setColor(Color.GREEN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedUnit) {
            canvas.drawText(hintString, centerX, centerY + 2 * textSize , hintPaint);
        }
        if (isNeedTitle) {
